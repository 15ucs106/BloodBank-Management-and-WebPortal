...
<?php
	...
	$cn=mysqli_connect("localhost","root","","bloodbank");
			$s="select * from staff where email='" . $_SESSION["email"] . "'";
...
<?php
	...
	if(isset($_POST["sbmt"])) 
	{
		$cn=makeconnection();
					...
					$s="update staff set name='" .$_POST["t1"]. "' ,gender='" .$_POST["r1"]."' , age='" .$_POST["t2"]. "',mobile='" .$_POST["t3"]. "' where email='" .$_SESSION["email"]. "'";
