...
<div style="height:500px;">
   ...
   <table cellpadding="0" cellspacing="0" width="600px" height="300px" class="tableborder" style="margin:auto; margin-top:100px;" >
     <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
    <tr><td colspan="2" align="center"><img src="Images/login21.png" width="300px" height="70px"></td></tr>
...
if(isset($_POST["sbmt"])) 
{
	...
	$cn=mysqli_connect("localhost","root","","bloodbank");			
			...
			$s="select *from staff where email='" . $_POST["t1"] . "' and pwd='" .$_POST["t2"] . "'";
...
echo "<script>location.replace('../staff/index.php');</script>";
	}
	else
	{
